...
namespace LaTienda2.Controllers
{
    public class ProductoSetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Codigo,Descripcion,Costo,MargenDeGanancia,PorcentajeIva,Rubro_Id,Marca_Id")] ProductoSet productoSet)
        {
            ...
            {
                productoSet.CalcularNetoGravado();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Codigo,Descripcion,Costo,MargenDeGanancia,Iva,NetoGravado,PorcentajeIva,PrecioDeVenta,Rubro_Id,Marca_Id")] ProductoSet productoSet)
        {
            if (ModelState.IsValid)
            {
