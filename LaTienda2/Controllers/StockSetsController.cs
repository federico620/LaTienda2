...
namespace LaTienda2.Controllers
{
    public class StockSetsController : Controller
    {
        ...
        {
            var stockSet = db.StockSet.Include(s => s.ColorSet).Include(s => s.ProductoSet).Include(s => s.TalleSet);
        ...
        public ActionResult Create([Bind(Include = "Id,Cantidad,Color_Id,Talle_Id,Producto_Id")] StockSet stockSet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Cantidad,Color_Id,Talle_Id,Producto_Id")] StockSet stockSet)
        {
            if (ModelState.IsValid)
            {
